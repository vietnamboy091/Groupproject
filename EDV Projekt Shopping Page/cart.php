<?php
    ...
    if($no_of_user_products==0){
        //echo "Fügt Items in Einkaufskorb. Zuerst";
    ?>
        <script>
    ...
    <body>
        <div>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy <a href="localhost/Denis/SCshop">Slick cloathing</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Arian Dauti, Laurentz Kretz, Emir Orcak, Denis Delwa</p>
               </center>
               </div>
           </footer>
        </div>
